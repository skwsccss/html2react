...
(function( $ ) {
	...
	**/
	var templates = {
		picker 	: $('<span class="bcPicker-picker"></span>'),
		palette : $('<span class="bcPicker-palette"></span>'),
		color 	: $('<span class="bcPicker-color"></span>')
	};
	...
	**/
	$.fn.bcPicker.defaults = {
        ...
        // default color set
        colors : [
					'cdd4de', 'dddddd', 'eeeeee', '666666', '999999', '333333',
					'000000', 'FF6600', '808000', '008000', '008080', '0000FF',
