...
$(document).ready(function () {
    ...
    //$(".announcement-emojis-toggle").click(function (ev) {
    //    $(".emojis-list01").toggleClass("show");
    //    return false;
    //});
    ...
    //    $('.dropdown-open').removeClass('current');
    //});
    //$('.user-list-dropdown a.popup').on('click', function () {
    //    $('.user-list li.show-box').addClass('current');
    //});
    ...
    if (viewPortWidth < 768) {
        if (sUsrAg.indexOf("Firefox") > -1) {
            $('#chatTab .tab-pane').addClass('firefox-height');
            $(".chat-input").focus(function () {
                setTimeout(function () {
                    var viewPortHeight = jQuery(window).height();
                    $('#chatTab .tab-pane').css('height', viewPortHeight - 70);
                }, 200);
            });
            ...
            if (Number(M[1]) < 72) {
                $('#chatTab .tab-pane').addClass('chrome72-height');
                
            } else {
                $('#chatTab .tab-pane').addClass('chrome-height');
                $('#chatTab .tab-pane').removeClass('chrome72-height');
                $('#chatTab .tab-pane').removeClass('safari-height');
                $('#chatTab .tab-pane').removeClass('firefox-height');
            }


            //sBrowser = "Google Chrome";
            if (sUsrAg.indexOf("SamsungBrowser") > -1) {
                $('#chatTab .tab-pane').removeClass('chrome-height');
                $('#chatTab .tab-pane').removeClass('safari-height');
                $('#chatTab .tab-pane').removeClass('firefox-height');
                $(".chat-input").focus(function () {
                    setTimeout(function () {
            ...
            if (sUsrAg.indexOf("CriOS") > -1) {
                //alert('call');
                var ua = navigator.userAgent, tem,
                    M = ua.match(/(CriOS(?=\/))\/?\s*(\d+)/i) || [];
                if (/trident/i.test(M[1])) {
                    tem = /\brv[ :]+(\d+)/g.exec(ua) || [];
                    M[1] = "Internet Explorer";
                    M[2] = tem[1];
                ...
                if (M[1] === 'CriOS') {
                    tem = ua.match(/\b(OPR|Edge)\/(\d+)/);
                    if (tem != null) M[1] = tem.slice(1).join(' ').replace('OPR', 'Opera'); else M[1] = "CriOS";
                ...
                } else if (Number(M[1]) == 69) {
                    $('#chatTab .tab-pane').addClass('chrome69-height');
                }
                else if (Number(M[1]) == 64) {
                    //alert('10');
                    $('#chatTab .tab-pane').addClass('chrome64-height');
                }
                else {
                    //alert(M[1]);
                    $('#chatTab .tab-pane').addClass('chrome-height');
                    $('#chatTab .tab-pane').removeClass('chrome72-height');
                    $('#chatTab .tab-pane').removeClass('chrome69-height');
                    $('#chatTab .tab-pane').removeClass('safari-height');
                    $('#chatTab .tab-pane').removeClass('firefox-height');
                }

            }
            $('#chatTab .tab-pane').addClass('safari-height');
    ...
    if ($(this).width() > 768) {
        ...
        $('#example').DataTable({
            ...
            "language": {
                search: "",
                oPaginate: {
                    sNext: '<img src="dist/theme01/images/next-page.png" class="img-fluid">',
                    sPrevious: '<img src="dist/theme01/images/prev-page.png" class="img-fluid">',
                    sFirst: '<img src="dist/theme01/images/first-page.png" class="img-fluid">',
                    sLast: '<img src="dist/theme01/images/last-page.png" class="img-fluid">'
                }
            }
        });
    } else {
