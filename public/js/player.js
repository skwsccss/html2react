...
function radioPlayerDrag() {
    $.fn.videoPlayer = function (extras) {
        ...
        $(this).append('<div class="controls bg-radio">\
<div class="leftblock">\
<a tabindex="1" href="#" class="play smooth noload"></a>\
<a tabindex="1" href="#" class="pause smooth noload"></a>\
</div>\
<div class="progress">\
<div class="other-options">\<i class="share-icon"></i>\<i class="theme-fullscreen"></i>\</div>\
<span>' + settings.name + '</span>\
<span class="byname">' + settings.byname + '</span>\
...
<div class="jp-mute smooth noload"></div>\
<div class="jp-unmute smooth noload"></div>\
<div class="volumeBar">\
    ...
    function createPlayer(playerGUI, mainPlayer, settings, extras) {
        ...
        $(playerGUI + ' .currentVolume').slider({
            ...
            slide: function () {
                ...
                //$(playerGUI + ' .volumeText').html('الصوت : ' + (value * 100).toFixed(0) + '');
            }
        });
