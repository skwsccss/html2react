...
(function ($) {
    ...
    if (viewPortWidth < 768) {
        $(".chat-input").focus(function () {
            ...
            $('#chatTab .tab-pane').css('height', viewPortHeight - 60);
            setTimeout(function () {
                var myDiv = document.getElementsByClassName("tab-pane")[0];
                myDiv.scrollTop = myDiv.scrollHeight;
        ...
        $(".chat-input01").focus(function () {
            //alert(viewPortHeight);
            $('.footer-middle').addClass('hide');
            $('.mob-footer').addClass('change-height');
            $('#privatechat-popup').css('height', viewPortHeight - 60);
            //$('.scroll-privatechat').css('max-height', '100vh');
            setTimeout(function () {
        ...
        $(".group-conversation-input .chat-input01").focus(function () {
            ...
            $('.footer-middle').addClass('hide');
            $('.mob-footer').addClass('change-height');
            //$('#groupconversation-popup').css('height', viewPortHeight - 390);
...
function chatHeightInputs() {
    ...
    if (viewPortWidth < 768) {
        $(".chat-input").focus(function () {
            ...
            $('#chatTab .tab-pane').addClass('chat-height');
            //$('#chatTab .tab-pane').css('height', viewPortHeight - 60);
            $('#chatTab .tab-pane').css('height', viewPortHeight - 390);
            setTimeout(function () {
                var myDiv = document.getElementsByClassName("tab-pane")[0];
                myDiv.scrollTop = myDiv.scrollHeight;
        ...
        $(".chat-input01").focus(function () {
            ...
            $('.footer-middle').addClass('hide');
            $('.mob-footer').addClass('change-height');
            $('#privatechat-popup').css('height', viewPortHeight - 390);
            //$('.scroll-privatechat').css('max-height', '100vh');
            setTimeout(function () {
                var myDiv = document.getElementsByClassName("privatechat-scroll")[0];
                myDiv.scrollTop = myDiv.scrollHeight;
...
function groupchatScrollHeight() {
    ...
    if (width < 768) {
        ...
        //alert(videoheight);
        $('.group-chatscroll').css('max-height', diff - 20);
    }
}
