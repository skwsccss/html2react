                ...
                <div className="navbar row  mob-show top-header pl-0 align-items-center room-header">
                    <div className="col-auto mr-auto">
                        <div className="profile-mob">
                            <img src="/css/dist/theme01/images/logo.png" className="img-fluid room-logo ml-2" alt="noimg" />
                        </div>
                    </div>
                    <div className="col-auto header-icons room-page-header">
                        <div className="btn-group">
                            <button type="button" className="btn btn-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <div className="room-profile-pics"><img src="/css/dist/theme01/images/chat-photo.jpg" className="img-fluid" alt="noimg" /></div>
