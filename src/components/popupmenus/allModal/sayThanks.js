...
export default class SayThanks extends Component {
    render() {
        return (
            <div className="modal01 fadeIn footer-links center-msg-box small-box-popup show trnasform" id="saythanks-popup" tabIndex="-1" role="dialog" aria-labelledby="saythanks-popup" aria-hidden="true">
                <div className="modal-dialog saythanks-model sm-modal" role="document">
                    <div className="modal-content">
                                ...
                                <div className="say-thanks-box d-flex">
                                    <div className="w-60 text-center m-b-xs">
                                        <div className="gift-image v-c-60">
                                            <a href="#ref" data-toggle="tooltip" title="Lolipop"><img src="/css/dist/theme01/images/gifts/01.png" className="img-fluid" alt="noimg" /></a>
                                        </div>
                        ...
                        <div className="modal-footer">
                            <button type="button" className="btn sm-btn theme-bg mob-radius-btn" data-toggle="tooltip" title="Say Thanks">Say Thanks</button>
                            <button type="button" className="btn sm-btn dark-gray-bg mob-radius-btn cancel-btn" data-dismiss="modal" data-toggle="tooltip" title="Close">Close</button>
                        </div>
                    </div>
                </div>
            </div>
