...
export default class PrivateMsgRec extends Component {
    render() {
        return (
            ...
            <div className="modal01 fadeIn footer-links  center-msg-box show transform" id="private-message-request" tabIndex="-1" role="dialog" aria-labelledby="private-message-request" aria-hidden="true">
                            ...
                            <div className="row no-gutters align-items-center  justify-content-center">
                                <div className="col-12 d-flex justify-content-center col-md-2 m-text-center mob-col-12">
                                    <div className="img-box ban-image">
                                        <img src="/css/dist/theme01/images/private-msg-icon.png" className="img-fluid" alt="no img" />
                                    </div>
                                ...
                                <div className="modal-btn-group modal-footer modal-btn-links popup-btns d-flex align-items-center justify-content-center mt-2">
                                    <a className="btn sm-btn mob-lg-btn theme-bg mob-radius-btn m-r-sm input-change order-1 z-disable hide-other-model privatechat-popup" href="#privatechat-popup" data-toggle="tooltip" title="Accept&Open">Accept & Open</a>
                                    <a href="#reject" className="btn sm-btn dark-gray-bg mob-radius-btn cancel-btn order-2" data-toggle="tooltip" title="Reject">Reject</a>
                                </div>
                            </div>
