...
export default class ExceedLimit extends Component {
    render() {
        return (
            <div className="modal01 fadeIn footer-links center-msg-box show" id="exceed-limit-popup" tabIndex="-1" role="dialog" aria-labelledby="exceed-limit-popup" aria-hidden="true">
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="modal-btn-group modal-footer modal-btn-links popup-btns d-flex pl-2 align-items-center justify-content-center">
                                <a className="btn sm-btn theme-bg mob-radius-btn m-r-sm z-disable background-process-hide wait-system-popup" href="#wait-system-popup"data-toggle="tooltip" title="Well i understand that">Well i understand that</a>
                            </div>
                        </div>
