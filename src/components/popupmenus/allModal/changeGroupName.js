...
export default class ChangeGroupName extends Component {
    render() {
        return (
            <div className="modal01 fadeIn footer-links transform center-transform" id="change-groupname-popup" tabIndex="-1" role="dialog" aria-labelledby="change-groupname-group-popup" aria-hidden="true">
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="modal-btn-group modal-btn-links popup-btns d-flex align-items-center mt-0 justify-content-center">
                                <a href="#save" className="btn sm-btn theme-bg mob-radius-btn m-r-sm cancel-btn order-1" title="Save">Save</a>
