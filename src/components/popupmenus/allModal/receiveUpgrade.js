...
export default class ReceiveUpgrade extends Component {
    render() {
        return (
            <div className="modal01 fadeIn footer-links center-msg-box transform show" id="receiveupgrade-popup" tabIndex="-1" role="dialog" aria-labelledby="receiveupgrade-popup" aria-hidden="true">
                <div className="modal-dialog receiveupgrade-model sm-modal" role="document">
                    <div className="modal-content">
                                ...
                                <div className="say-thanks-box d-flex">
                                    <div className="w-60 text-center m-b-xs">
                                        <div className="gift-image v-c-60">
                                            <a href="#lolipop" data-toggle="tooltip" title="Lolipop"><img src="/css/dist/theme01/images/vip-upgrade.png" className="img-fluid" alt="no img" /></a>
                                        </div>
                        ...
                        <div className="modal-footer">
                            <button type="button" className="btn sm-btn theme-bg mob-radius-btn z-disable purchase-popup" href="#purchase-popup" data-toggle="tooltip" title="Say Thanks">Say Thanks</button>
                            <button type="button" className="btn sm-btn dark-gray-bg mob-radius-btn cancel-btn" data-toggle="tooltip" title="Close">Close</button>
                        </div>
                    </div>
                </div>
            </div>
