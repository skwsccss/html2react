        ...
        return (
            <div className="voice-calling hide">
                <div className="resize-actions slider-resize">
                    <a href="#full-screen" className="mobile-resize-icon calling-full-screen"  data-toggle="tooltip" title="Full-Screen"><img src="/css/dist/theme01/images/full-screen-icon.png" className="img-fluid z-disable" alt="no img"  /></a>
                ...
                <div className="calling-action">
                    <a className="icon-change" href="#volume"  data-toggle="tooltip" title="Volume">
                    ...
                    <a href="#endcall" className="endcall-btn"  data-toggle="tooltip" title="End Call"><img src="/css/dist/theme01/images/end-call.png" className="img-fluid" alt="no img"  /> END CALL</a>
                    <a className="icon-change" href="#mutemic"  data-toggle="tooltip" title="Mutemic">
