        ...
        return (
            <div className="video-calling hide">
                <div className="resize-actions slider-resize">
                    <a className="mobile-resize-icon calling-full-screen"  data-toggle="tooltip" title="Full-Screen" href="#d"><img src="/css/dist/theme01/images/full-screen-icon.png" className="img-fluid z-disable" alt="no" /></a>
                    ...
                    <div className="video-box">
                        ...
                        <div className="actions two-row-action">
                            <div className="video-options">
                                <a className="icon-change" href="#h"  data-toggle="tooltip" title="Camera">
                ...
                <div className="calling-action">
                    <span className="full-box-option hide">
                        <a className="icon-change" href="#h"  data-toggle="tooltip" title="Mic">
                            <img src="/css/dist/theme01/images/mic-off.png" className="w-18 img-fluid enable-icon" alt="no img" />
                            <img src="/css/dist/theme01/images/mic-on.png" className="w-18 img-fluid disable-icon" alt="no img" />
                        </a>
                        <a className="icon-change" href="#h"  data-toggle="tooltip" title="Video">
                    ...
                    <a href="#h" className="endcall-btn"  data-toggle="tooltip" title="End Call">
