...
export default class PrivateChatPopup extends Component {
    render() {
        return (
            <div className="modal01 fadeIn footer-links height-match bot show trasform" id="privatechat-popup" tabIndex="-1" role="dialog" aria-labelledby="privatechat-popup" aria-hidden="true">
                        ...
                        <span className="box-title theme-bg justify-content-between">
                            ...
                            <span className="mark-read-btn">
                                <span className="d-flex">
                                    <button type="button" data-id="privatechat-popup" className="maximize maximize-privateChat" data-dismiss="modal" aria-label="maximize"  data-toggle="tooltip" title="Maximize">
                                        <span aria-hidden="true"><img src="/css/dist/theme01/images/maximize-icon.png" className="img-fluid" alt="no img" /></span>
                                    </button>
                                    <button type="button" className="minimize chatbody-area" data-dismiss="modal" aria-label="minimize"  data-toggle="tooltip" title="Minimize">
