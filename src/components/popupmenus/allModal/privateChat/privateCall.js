            ...
            <div className="private-call-block">
                ...
                <div className="private-audio-call">
                    <div className="d-flex white-box mb-3">
                        ...
                        <div className="avtar-friend">
                            <img src="/images/dc.png" className="img-fluid" alt="no img" />
                        </div>
                        <div className="call-option">
                            <a href="#h" className="round-border " title="Video"><img src="/images/blue-camera.png" className="img-fluid call-icon" alt="mo" /></a>
                    ...
                    <div className="d-flex white-box mb-3">
                        ...
                        <div className="call-option">
                            <a href="#h" className="round-border " title="Video"><img src="/images/blue-camera.png" className="img-fluid call-icon" alt="no" /></a>
                            <a href="#h" className="round-border" title="Video"><i className="sprite gift-box01-ico"></i></a>
                            <a href="#h" className="round-border" title="Video"><i className="sprite ignore-ico"></i></a>
                            <a href="#h" className="round-border" title="Video"><i className="sprite profile-ico"></i></a>
                        </div>
                ...
                <div className="private-video hide video-model">
                    <div className="video-box">
                        ...
                        <img src="/images/video-bg.png" className="img-fluid hidden-mob" alt="no" />
                        <div className="actions">
                            ...
                            <a href="#h" title="Gift"><img src="/images/lg-gift.png" className="img-fluid" alt="no" /></a>
                            <a href="#h" title="User"><img src="/images/lg-user.png" className="img-fluid" alt="no" /></a>
                        </div>
                        <div className="resize-actions">
                            <a href="#h" className="hidden-mob" title="Zoom-In"><img src="/images/plus-icon.png" className="img-fluid" alt="no" /></a>
                            <a href="#h" className="hidden-mob" title="Zoom-Out"><img src="/images/minus-icon.png" className="img-fluid" alt="no" /></a>
                            <a href="#h" className="hidden-mob" title="Full-Screen"><img src="/images/full-screen-icon.png" className="img-fluid" alt="no" /></a>
                        </div>
                        <div className="network-signal">
                            <a href="#h" title="Network" className="hidden-mob"><img src="/images/network-icon.png" className="img-fluid" alt="no" /></a>
                        </div>
                    </div>
                    <div className="video-box">
                        <div className="friend-name">Hi</div>
