...
export default class Logout extends Component {
    render() {
        return (
            <div className="modal01 fadeIn footer-links transform center-transform transform show" id="logout-popup" tabIndex="-1" role="dialog" aria-labelledby="logout-popup" aria-hidden="true">
