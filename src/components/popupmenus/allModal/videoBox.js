                                ...
                                <div className="col-12 m-text-center">
                                    <div className="video-box">
                                        ...
                                        <div className="actions">
                                            ...
                                            <a href="#href" title="Gift"><img src="/css/dist/theme01/images/lg-gift.png" className="img-fluid" alt="no img" /></a>
                                            <a href="#href" title="User"><img src="/css/dist/theme01/images/lg-user.png" className="img-fluid" alt="no img" /></a>
                                        </div>

                                        <div className="resize-actions">
                                            <a href="#href" title="Zoom-In" className="hidden-mob"><img src="/css/dist/theme01/images/plus-icon.png" className="img-fluid" alt="no img" /></a>
                                            <a href="#href" title="Zoom-Out" className="hidden-mob"><img src="/css/dist/theme01/images/minus-icon.png" className="img-fluid" alt="no img" /></a>
                                            <a href="#href" className="mobile-resize-icon" title="Full-Screen"><img src="/css/dist/theme01/images/full-screen-icon.png" className="img-fluid" alt="no img" /></a>
                                        </div>
                                        <div className="network-signal">
                                            <a href="#href" title="Network" className="hidden-mob"><img src="/css/dist/theme01/images/network-icon.png" className="img-fluid" alt="no img" /></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
