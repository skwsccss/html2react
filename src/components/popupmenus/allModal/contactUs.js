...
export default class ContactUs extends Component {
    render() {
        return (
            <div className="modal01 fadeIn footer-links transform center-transform" id="contactus-popup" tabIndex="-1" role="dialog" aria-labelledby="contactus-popup" aria-hidden="true">
                                ...
                                <div className="col-12 col-md-12 pl-2 m-pl-0 confirm-txt m-text-center">
                                    <div className="mob-t-4">
                                        <div className="d-flex align-content-center justify-content-between">
                                            ...
                                            <span>
                                                <a href="#whatsapp" target="_blank" title="whatsapp"><i className="whatsapp-ico mr-2"></i></a>
                                                <a href="#facebook" target="_blank" title="facebook"><i className="facebook-ico"></i></a>
                                            </span>
                                        </div>
