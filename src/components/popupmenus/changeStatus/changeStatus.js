    ...
    render() {
        return (
            <span className="dropdown-menu change-status sidebar-status-menu width-count">
                <span className="user-name theme-bg">Change Status<span className="detail-close-btn" data-toggle="tooltip" title="Close">X</span></span>
                ...
                <span className="seprator account-link">
                    ...
                    <a className="dropdown-item change-avtar-popup" href="#change-avtar-popup" data-toggle="tooltip" title="Change Avatar"><img src="/css/dist/theme01/images/right-icon.png" className="img-fluid" alt="no-img" />Change Avatar</a>
                </span>
                <a className="dropdown-item logout z-disable logout-popup" href="#logout-popup" data-toggle="tooltip" title="Logout"><img src="/css/dist/theme01/images/logout.png" className="img-fluid" alt="no-img" />Logout</a>
            </span>
        )
    }
}
